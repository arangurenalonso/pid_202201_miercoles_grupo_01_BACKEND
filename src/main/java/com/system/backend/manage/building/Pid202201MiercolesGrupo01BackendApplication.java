...
public class Pid202201MiercolesGrupo01BackendApplication implements WebMvcConfigurer {
	...
	CommandLineRunner run(UsuarioService userService, 
		...
		return args -> {
			...
			departService.crearDepartamento(new DepartamentoDTO(null, "100", "902579922", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "101", "901547831", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "102", "903651875", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "103", "936427437", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "104", "9462131351", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "105", "9641318411", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "106", "9654112233", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "107", "9642311796", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "108", "9414111637", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "109", "9999999999", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "110", "9111111111", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "111", "9333244165", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "112", "9445556631", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "113", "9663332147", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "114", "9000345144", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "115", "9256314563", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "116", "9642136156", true,(long)1));

			departService.crearDepartamento(new DepartamentoDTO(null, "117", "9541321354", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "118", "9666666666", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "119", "9563216112", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "120", "9202366325", true,(long)1));

			departService.crearDepartamento(new DepartamentoDTO(null, "200", "902579922", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "201", "901547831", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "202", "903651875", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "203", "936427437", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "204", "9462131351", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "205", "9641318411", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "206", "9654112233", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "207", "9642311796", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "208", "9414111637", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "209", "9999999999", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "210", "9111111111", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "211", "9333244165", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "212", "9445556631", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "213", "9663332147", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "214", "9000345144", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "215", "9256314563", true,(long)1));
			departService.crearDepartamento(new DepartamentoDTO(null, "216", "9642136156", true,(long)1));
