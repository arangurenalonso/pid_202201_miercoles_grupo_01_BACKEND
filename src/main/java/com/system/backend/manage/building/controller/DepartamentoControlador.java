...
public class DepartamentoControlador {
	...
	public ResponseEntity<?> guardarDepartamento(@RequestBody DepartamentoDTO departamentoDTO) {
		...
		if (departamentoRespuesta == null) {
			...
			response.setMessage("Data no valida ");
		...
		response.setDetalle(errorDetalles);
		response.setMessage("Se creo el departamento");
	...
	public ResponseEntity<?> actualizarDepartamento(@RequestBody DepartamentoDTO departamentoDTO,
		...
		response.setType("Success");
		response.setDetalle(errorDetalles);
		response.setMessage("Se actualizo el departamento");
		return new ResponseEntity<>(response, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> eliminarDepartamento(@PathVariable(name = "id") long id) {
		...
		response.setType("Success");
		response.setDetalle(errorDetalles);
		response.setMessage("Se encontro el departamento");
		return new ResponseEntity<>(response, HttpStatus.OK);
